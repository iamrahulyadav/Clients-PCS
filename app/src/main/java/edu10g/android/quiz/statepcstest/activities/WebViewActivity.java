...
import edu10g.android.quiz.statepcstest.utility.AvenuesParams;
import edu10g.android.quiz.statepcstest.utility.Constants;
import edu10g.android.quiz.statepcstest.utility.LoadingDialog;
import edu10g.android.quiz.statepcstest.utility.RSAUtility;
import edu10g.android.quiz.statepcstest.utility.ServiceUtility;
...
public class WebViewActivity extends AppCompatActivity {
    ...
    private JSONObject addJsonObjects(String str, String id) {
        try {
            ...
            packet.put(edu10g.android.quiz.statepcstest.common.Constants.AppId, edu10g.android.quiz.statepcstest.common.Constants.AppIdValue);
            //packet.put("")
            return packet;
        } catch (Exception e) {
