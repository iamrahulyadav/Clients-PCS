...
import edu10g.android.quiz.statepcstest.interfaces.IOneBtnDialogListener;
import edu10g.android.quiz.statepcstest.models.Banner;
import edu10g.android.quiz.statepcstest.views.CustomDialog;
...
public class ApplicationGlobal extends Application
{
    ...
    public void browserLink(Banner banner){
        try {

            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://edu10g.com/"));
